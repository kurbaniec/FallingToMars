...
namespace Player
{
    public class GalaxyMinifigInputManager : MonoBehaviour
    {
        private GalaxyMinifigController m_MinifigController;
        //private GameFlowManager m_GameFlowManager;

        void Awake()
        {
            m_MinifigController = GetComponent<GalaxyMinifigController>();
