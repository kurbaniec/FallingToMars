...
namespace Unity.LEGO.Minifig
{
    ...
    public class GigisMinifigController : MonoBehaviour
    {
        // Constants.
            ...
            if (inputEnabled)
            {
                switch (inputType)
                {
                    case InputType.Tank:
                        {
                            // Calculate speed.
                            var targetSpeed = movementInput.y;
                            ...
                            var targetRotateSpeed = movementInput.x;
                ...
                // Cancel special.
                cancelSpecial = !Mathf.Approximately(movementInput.y, 0) || !Mathf.Approximately(movementInput.x, 0) || jumped;
